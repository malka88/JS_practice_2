...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.marginRight = "".concat(_calcScroll__WEBPACK_IMPORTED_MODULE_1__["default"], "px");
      });
    });
  ...
  showModalByTime('.popup-consultation', 6000); //showModalByTime('.popup', 60000);
};
